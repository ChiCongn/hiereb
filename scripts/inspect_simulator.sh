...
service_env simulator '^(SUPPRESSION_MODE|RUN_ID|REPLAY_SPEED|STREAM_TIME_MODE|DATASET_PRESET|DATA_WINDOW|ONE_HOUSE_ID|FIVE_HOUSE_IDS|HOUSE_IDS|DATA_FILE|DATA_GLOB|DATA_PATH|EPSILON_H|TAU|BATCH_INTERVAL_SECONDS|UNIFORM_DELTA|KAFKA_BOOTSTRAP_SERVERS|LOG_LEVEL)='
