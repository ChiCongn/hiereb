...
service_env ml-hiereb '^(SUPPRESSION_MODE|RUN_ID|REPLAY_SPEED|HOUSE_IDS|DATA_FILE|DATA_PATH|EPSILON_H|TAU|BATCH_INTERVAL_SECONDS|KAFKA_BOOTSTRAP_SERVERS|LOG_LEVEL)='
